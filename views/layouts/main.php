...
<?php $this->beginBody() ?>
        ...
        <div class="wrapper">
                    ...
                    <nav class="mt-2">
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                            ...
                            <li class="nav-item has-treeview menu-open">
                                <a href="<?= Url::to(['home/index']) ?>" class="nav-link">
                            ...
                            <li class="nav-item has-treeview">
                                <a href="<?= Url::to(['suratmasuk/index']) ?>" class="nav-link">
                            ...
                            <li class="nav-item has-treeview">
                                    <a href="<?= Url::to(['suratkeluar/index']) ?>" class="nav-link">
                            ...
                            <li class="nav-item has-treeview">
                                <a href="<?= Url::to(['suratcekal/index']) ?>" class="nav-link">
                                    <i class="nav-icon fa fa-envelope"></i>
                                    <p>
                                        Surat Cekal
                                    </p>
                            ...
                            <li class="nav-item has-treeview">
                                <a href="<?= Url::to(['lapinhar/index']) ?>" class="nav-link">
                            ...
                            <li class="nav-item has-treeview">
                                <a href="<?= Url::to(['lapinsus/index']) ?>" class="nav-link">
            ...
            <footer class="main-footer">
                ...
                <strong>Copyright &copy; 2014-2018 <a href="#">Radinal Dwiki N</a>.</strong> All rights
                reserved.
            </footer>
